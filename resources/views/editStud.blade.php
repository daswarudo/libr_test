...
<div class="card">
	<div class="card-header">Edit Student</div> {{-- ADD LATER --}}
    
	<div class="card-body">
        
		<form method="post" action="{{ url('updateStud/'.$student->s_id)}}">
          ...
          <div class="form-group">
              ...
              <input type="text" class="form-control" name="s_email"  value="{{$student->s_email}}"/>
          ...
          <div class="form-group">
              ...
              <input type="text" class="form-control" name="s_course"  value="{{$student->s_course}}"/>
          ...
          <div class="form-group">
              ...
              <input type="text" class="form-control" name="s_sy"  value="{{$student->s_sy}}"/>
              @if($errors->has('s_sy'))
